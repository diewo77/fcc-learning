function checkCashRegister(price, cash, cid) {
    ...
    console.log('someCid', someCid);
    if (change === someCid) {
        changeLetters = 'Closed';
    } else if (change > someCid) {
        changeLetters = 'Insufficient Funds';
    }
    // Here is your change, ma'am.
    console.log('changeLetters', changeLetters);
...
function checkCashRegister(price, cash, cid) {
    ...
    var change_arr = denom.reduce(function(acc, curr) {
        ...
        while (register[curr.name] > 0 && change >= curr.val) {
            ...
            console.log('register[curr.name]', register[curr.name]);
